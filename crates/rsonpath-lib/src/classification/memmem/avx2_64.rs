    ...
    'i: 'r,
{
    ...
    unsafe fn find_letter(
        ...
        let classifier = vector_256::BlockClassifier256::new(label.unquoted_bytes()[0], b'"');
        let mut previous_block: u64 = 0;
    ...
    unsafe fn find_label_avx2(
        ...
        let classifier = vector_256::BlockClassifier256::new(label.unquoted_bytes()[0], label.unquoted_bytes()[1]);
        let mut previous_block: u64 = 0;
